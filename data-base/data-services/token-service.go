...
func GenerateRefreshToken(shopId string, userName string, authorized bool, accessGroup []int) (string, string, error) {
...
func GeneratePassToken(shopId string, accessGroup []int) (string, string, error) {
...
func (dataService *DataServices) GenerateRefreshAndAuthTokenAndAddRefreshToCash(ctx context.Context, shopId string, userName string, authorized bool, accessGroup []int) (string, string, error) {

	token, refreshTokenId, err := GenerateRefreshToken(shopId, userName, authorized, accessGroup)
	...
	authToken, err := GenerateAuthToken(shopId, userName, refreshTokenId, authorized, accessGroup)
...
func (dataService *DataServices) GeneratePassTokenAndAddToCash(ctx context.Context, shopId string, accessGroup []int) (string, error) {

	token, passTokenId, err := GeneratePassToken(shopId, accessGroup)
	if err != nil {
		return "", err
	}
...
func GenerateAuthToken(shopId string, userName string, refreshTokenId string, authorized bool, accessGroup []int) (string, error) {
